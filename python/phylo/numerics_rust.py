"""Rust inverse-CDF categorical sampling (`phylo.oxiphylo.sample_rows`) --
pinned against :func:`phylo.numerics.sample_rows`, the NumPy oracle.
...
**The generator does not cross the boundary.** ``phylo.sim``'s
...
def sample_rows(
    ...
    Signature-compatible with :func:`phylo.numerics.sample_rows`, and
