...
(issue #230): ``200_000`` configurations in :mod:`phylo.likelihood.potts`,
``200_000`` paths in :mod:`phylo.likelihood.hmm_paths`, ``20`` nodes in
:mod:`phylo.search.max_cut`, and a docstring-only ``n <= 6`` in
:mod:`phylo.likelihood.brute_force` that nothing enforced --- four thresholds
