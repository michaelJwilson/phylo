"""Standard continuous test functions, as :class:`~phylo.opt.objective.Objective`.

Every other test of :func:`phylo.opt.fit.fit` measures a *statistical*
...
observed information matrix and :func:`phylo.opt.fit.constrained_standard_errors`
