...
where equality against :func:`phylo.likelihood.potts.enumerate_potts` is the
right assertion; the loopy case is *reported* against
:func:`phylo.likelihood.potts.strip_log_partition` as a measured deviation,
...
def belief_propagation(
    ...
    *,
    ...
    field : np.ndarray
        ...
        ``exp(h)``, matching :func:`phylo.likelihood.potts.log_weights`.
    damping : float
