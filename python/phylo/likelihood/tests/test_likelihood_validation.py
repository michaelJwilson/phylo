...
Separated from python/phylo/likelihood/tests/test_likelihood_pruning.py, which pins
scientific correctness; these pin the guardrails around malformed inputs,
mirroring python/phylo/sim/tests/test_jc_validation.py's split for the simulator.
"""
