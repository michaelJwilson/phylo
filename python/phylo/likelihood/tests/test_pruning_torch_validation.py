...
Separated from python/phylo/likelihood/tests/test_pruning_torch.py, which pins
scientific correctness; these pin the guardrails around malformed inputs,
mirroring python/phylo/likelihood/tests/test_likelihood_validation.py's split for the
NumPy oracle.
"""
