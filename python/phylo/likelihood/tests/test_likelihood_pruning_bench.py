...
See python/phylo/likelihood/tests/test_likelihood_pruning.py for correctness, pinned
...
def test_log_likelihood_benchmark(
    ...
    # separately in python/phylo/likelihood/tests/test_likelihood_pruning.py.
