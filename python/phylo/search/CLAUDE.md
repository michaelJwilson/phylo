...
application's instance of `phylo.learn`'s environment protocol.
...
stepping inside a fit — which is why this module may import `phylo.likelihood`
and `phylo.opt` while neither may import it. And the environment lives here
