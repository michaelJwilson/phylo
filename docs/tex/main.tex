...
it --- on every build, so the two cannot drift apart. Likelihood,
optimization, and search QA figures are not built yet; this section is
where their captions go once they are.
